...
from werkzeug.security import check_password_hash, generate_password_hash #REFACTORING .security
...
def init_db():
    ...
    with closing(connect_db()) as db:
        with app.open_resource('schema.sql') as f:
            db.cursor().executescript(f.read().decode('utf-8')) #REFACTORING decode
        db.commit()
